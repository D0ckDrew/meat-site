...
@Entity
@Table(name = "product_expense_reason", schema = "meat_site_db", catalog = "")
public class ProductExpenseReasonModel {
    private Long id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        ProductExpenseReasonModel that = (ProductExpenseReasonModel) o;
    ...
    @OneToMany(mappedBy = "productExpenseReasonByProductExpenseReasonId")
