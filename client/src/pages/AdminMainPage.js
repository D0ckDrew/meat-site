...
const AdminMainPage = observer(() => {
    ...
    return (
        <div>
            <AdminLayout>
                <Title level={2}>Добро пожаловать на web-портал учета и анализа деятельности малого предприятия по
                    производству мясной продукции!</Title>
                <Divider/>
                <Paragraph>На портале представлены основные функции по управлению и анализу деятельности
